...
if __name__ == "__main__":
    image1_path = "/home/gagagk16/Rain/Derain/AGEStormer/imgs/2.png"  # Path to the first image
    image2_path = "/home/gagagk16/Rain/Derain/AGEStormer/imgs/1.png"  # Path to the second image
